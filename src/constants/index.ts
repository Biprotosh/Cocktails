...
export const cocktailLists: TDrinkItem[] = [
...
export const mockTailLists: TDrinkItem[] = [
...
export const profileLists: TProfile[] = [
...
export const featureLists: TFeature[] = [
...
export const goodLists: TFeature[] = [
...
export const storeInfo: TStoreInfo = {
...
export const openingHours: TOpeningHour[] = [
...
export const sliderLists: TSliderItem[] = [
  {
    id: 1,
    name: "Classic Mojito",
